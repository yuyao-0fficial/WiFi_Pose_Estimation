...
def main():
    ...
    root = '/media/chiyage/数据/LYX_Learning_Files/My Researches/ISAC/User Equipment Tracing/HumanPoseEstimation/single_person_annotation_5/single person/'
    if stg == 0:
        ...
        if flag_train == 1:
            ...
            for i in range(total_train // batch_size):
                ...
                scio.savemat(
                    '//media/chiyage/数据/LYX_Learning_Files/My Researches/ISAC/User Equipment Tracing/HumanPoseEstimation/Encoder_output/train/stg_' + str(
                        stg) + '_' + str(i) + '.mat',
            ...
            for i in range(total_val // batch_val):
                ...
                scio.savemat(
                    '/media/chiyage/数据/LYX_Learning_Files/My Researches/ISAC/User Equipment Tracing/HumanPoseEstimation/Encoder_output/val/stg_' + str(
                        stg) + '_' + str(i) + '.mat',
                    {'Encoder_output': encoder_output['out'].cpu().detach().numpy()})
        ...
        loss_val = []
        # 加载数据
        root = '/media/chiyage/数据/LYX_Learning_Files/My Researches/ISAC/User Equipment Tracing/HumanPoseEstimation/Encoder_output/'
        ...
        if flag_train == 1:
            ...
            for i in range(0, total_test // batch_test):
                ...
                t_e = time.time()
                scio.savemat(
                    '/media/chiyage/数据/LYX_Learning_Files/My Researches/ISAC/User Equipment Tracing/HumanPoseEstimation/Single Person Output/posit_stg' + str(
                        stg) + '_' + str(i) + '_2.mat',
                    {'Position': model_out['Position'].cpu().detach().numpy()})
                scio.savemat(
                    '/media/chiyage/数据/LYX_Learning_Files/My Researches/ISAC/User Equipment Tracing/HumanPoseEstimation/Single Person Output/heatmap_stg' + str(
                        stg) + '_' + str(i) + '_2.mat',
                    {'HeatMap': model_out['HeatMap'].cpu().detach().numpy()})
                scio.savemat(
                    '/media/chiyage/数据/LYX_Learning_Files/My Researches/ISAC/User Equipment Tracing/HumanPoseEstimation/Single Person Output/depth_stg' + str(
                        stg) + '_' + str(i) + '_2.mat',
                    {'Depth': model_out['Depth'].cpu().detach().numpy()})
                scio.savemat(
                    '/media/chiyage/数据/LYX_Learning_Files/My Researches/ISAC/User Equipment Tracing/HumanPoseEstimation/Single Person Output/posit_test_stg' + str(
                        stg) + '_' + str(i) + '_2.mat',
                    {'Position': posit_test.cpu().detach().numpy()})
                scio.savemat(
                    '/media/chiyage/数据/LYX_Learning_Files/My Researches/ISAC/User Equipment Tracing/HumanPoseEstimation/Single Person Output/heatmap_test_stg' + str(
                        stg) + '_' + str(i) + '_2.mat',
                    {'HeatMap': heatmap_test.cpu().detach().numpy()})
                scio.savemat(
                    '/media/chiyage/数据/LYX_Learning_Files/My Researches/ISAC/User Equipment Tracing/HumanPoseEstimation/Single Person Output/depth_test_stg' + str(
                        stg) + '_' + str(i) + '_2.mat',
                    {'Depth': depth_test.cpu().detach().numpy()})
                scio.savemat(
                    '/media/chiyage/数据/LYX_Learning_Files/My Researches/ISAC/User Equipment Tracing/HumanPoseEstimation/Single Person Output/img_test_stg' + str(
                        stg) + '_' + str(i) + '_2.mat',
                    {'img': jpeg_test})
